...
def transformar_dim_persona(cotizante, beneficiario, cotizante_beneficiario):
    ...
    cols_seleccionadas = ['tipo_documento', 'numero_identificacion', 'nombre', 'fecha_nacimiento', 'sexo', 'estado_civil', 'tipo_discapacidad',
    ...
    # renombrar y seleccionar campos
    merged_table = etl.rename(merged_table, {'tipo_identificacion': 'tipo_documento', 'id_beneficiario': 'numero_identificacion',
